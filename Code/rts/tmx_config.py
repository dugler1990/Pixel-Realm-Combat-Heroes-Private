...
NODE_SPECS = {
    ...
    "ice_shelf": {
        ...
        "gather_offset_y": 0,
        "gather_slot_cols": 5,
        "gather_slot_spacing": 22,
        "gather_slot_front_y": 18,
        "max_ice": 100,
        "visual_layers": [
            {"ice_capacity": 25, "folder": "ice_shelf/layer_0", "frame_interval_sec": 0.2},
            {"ice_capacity": 25, "folder": "ice_shelf/layer_1", "frame_interval_sec": 0.2},
            {"ice_capacity": 25, "folder": "ice_shelf/layer_2", "frame_interval_sec": 0.2},
            {"ice_capacity": 25, "folder": "ice_shelf/layer_3", "frame_interval_sec": 0.2},
        ],
    },
    "walrus_shore": {
        "type": "resource_node",
